I'm a self-taught systems programmer from Spain. I value depth, knowing how things truly work under the hood, rather than just how to use them. Understanding the inner mechanisms of a system is what makes you able to administer and defend it effectively. 

I gravitate towards low-level programming because there are no abstractions to hide behind, and I find the elegance and precision of it to be compelling. My focus is systems programming, \*nix internals, and networking. My favourite languages are C and Bash. 
